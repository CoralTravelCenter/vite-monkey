# sunmar-ny-2027-promotion-metric
...
```bash
npm run dev:experiment -- brands/sunmar/sunmar-ny-2027-promotion-metric
npm run build:experiment -- brands/sunmar/sunmar-ny-2027-promotion-metric
```
