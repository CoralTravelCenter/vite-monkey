# metrica-sunmar-rb-2027-all-pages
...
```bash
npm run dev:experiment -- brands/sunmar/banner-rb-winter-2027-all-pages
npm run build:experiment -- brands/sunmar/banner-rb-winter-2027-all-pages
```
