...
export class Tooltip {
	...
	generateTooltipMarkup() {
		...
		this.tooltip.innerHTML = `<div class="tooltip-content"><span class="erid">${vendor}.&nbsp;erid:&nbsp;<span>${this.settings.erid}</span></span>
	...
	render() {
		if (!this.rendered) {
			...
			this.container.parentElement.append(this.tooltip)
			this.events()
			this.rendered = true
		}
	}
	...
	events() {
		...
		this.container.addEventListener('click', () => {
			this.tooltip.classList.toggle('js-active')
		});
