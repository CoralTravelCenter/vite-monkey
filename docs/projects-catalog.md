...
|---|---|---|---|---|---|---|
| `brands/coral/404` | `404` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | project name duplicates `404`; has experiment.config.json |
...
| `brands/coral/banners-add-passenger` | `banners-add-passenger` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
...
| `brands/coral/busines-popup-on-flight` | `busines-popup-on-flight` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
...
| `brands/coral/charter-regular-active` | `charter-regular-active` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
...
| `brands/coral/china-cards` | `china-cards` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
...
| `brands/coral/coral-popup-cyber-promo` | `coral-popup` | coral | needs-review | `src/main.js` | `https://www.coral.ru/` | package name duplicates `coral-popup`; package name does not match folder; has experiment.config.json; project name duplicates `coral-popup`; project name does not match folder |
...
| `brands/coral/football-banner-chain-turkey` | `football-banner-chain-turkey` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
...
| `brands/coral/hello-banner-main-russia` | `hello-banner-main-russia` | coral | needs-review | `src/main.js` | `https://www.coral.ru/main/russia/` | has experiment.config.json |
...
| `brands/coral/home-page-advantage` | `home-page-advantage` | coral | needs-review | `src/main.js` | `https://www.coral.ru/` | has experiment.config.json |
...
| `brands/coral/june-popup-home` | `june-popup-home` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
...
| `brands/coral/kapsula-popup` | `kapsula-popup` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
| `brands/coral/lead-form-add-passegers` | `lead-form-add-passegers` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
| `brands/coral/lead-form-bitrix-24-coralby` | `lead-form-bitrix-24-coralby` | coral | needs-review | `src/main.js` | `https://www.coral.by/*` | has experiment.config.json |
| `brands/coral/magic-ball` | `magic-ball` | coral | needs-review | `src/main-mob.js` | `https://www.coral.ru/*` | has experiment.config.json |
| `brands/coral/maldives-cards` | `maldives-cards` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
...
| `brands/coral/new-metrika-carousel` | `new-metrika-carousel` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
...
| `brands/coral/pay-attention-slider-fix` | `pay-attention-slider-fix` | coral | needs-review | `src/main.js` | `https://www.coral.ru/preview/360f3d83-7c9d-45d3-8fe0-1d77a98259db/ru-RU/` | has experiment.config.json |
...
| `brands/coral/popup-home-promo` | `popup-home-promo` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
| `brands/coral/popup-russia-promo` | `popup-russia-promo` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
...
| `brands/coral/search-research` | `search-research` | coral | needs-review | `src/main.js` | `https://www.coral.ru/poleznaya-informatsiya/offers/start-prodazh-vietnam/*` | has experiment.config.json |
...
| `brands/coral/shambertest` | `shambertest` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
| `brands/coral/shild-hotels-week` | `shild-hotels-week` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
...
| `brands/coral/ym-test` | `ym-test` | coral | needs-review | `src/main.js` | `https://www.coral.ru/preview/1c107d6f-4240-4adc-88e4-30b0ff8563da/ru-RU/` | has experiment.config.json |
| `brands/coral/zaglushka` | `zaglushka` | coral | needs-review | `src/main.js` | `https://www.coral.ru/*` | has experiment.config.json |
| `brands/sunmar/404` | `404` | sunmar | needs-review | `src/main.js` | `https://www.sunmar.ru/*` | project name duplicates `404`; has experiment.config.json |
| `brands/sunmar/ab-test-home-shorten` | `ab-test-home-shorten` | sunmar | needs-review | `src/main.js` | `https://www.sunmar.ru/*` | has experiment.config.json |
...
| `brands/sunmar/promo-popup` | `promo-popup` | sunmar | needs-review | `src/main.js` | `https://www.sunmar.ru/*` | has experiment.config.json |
| `brands/sunmar/promo-popup-home` | `promo-popup-home` | sunmar | needs-review | `src/main.js` | `https://www.sunmar.ru/*` | has experiment.config.json |
| `brands/sunmar/redirect-to-new-site` | `redirect-to-new-site` | sunmar | needs-review | `src/main.js` | `https://www.sunmar.ru/` | package name duplicates `redirect-to-new-site`; has experiment.config.json; project name duplicates `redirect-to-new-site` |
| `brands/sunmar/secret-popup` | `secret-popup` | sunmar | needs-review | `src/main.js` | `https://www.sunmar.ru/*` | has experiment.config.json |
| `brands/sunmar/sm-form-adaptive-height` | `sm-form-adaptive-height` | sunmar | needs-review | `src/main.js` | `https://new.sunmar.ru/` | has experiment.config.json |
...
| `brands/sunmar/sunmar-bonus-shild-search` | `sunmar-bonus-shild-search` | sunmar | needs-review | `src/main.js` | `https://www.sunmar.ru/` | has experiment.config.json |
| `brands/sunmar/sunmar-egei-quiz-2025` | `sunmar-egei-quiz-2025` | sunmar | needs-review | `src/main.js` | `https://www.sunmar.ru/*` | has experiment.config.json |
| `brands/sunmar/sunmar-home-page-polish` | `home-page-polish` | sunmar | needs-review | `src/main.js` | `https://new.sunmar.ru/` | has experiment.config.json |
...
| `brands/sunmar/sunmar-popup-cyber-promo` | `coral-popup` | sunmar | needs-review | `src/main.js` | `https://www.sunmar.ru/` | package name duplicates `coral-popup`; package name does not match folder; has experiment.config.json; project name duplicates `coral-popup`; project name does not match folder |
