...
export type DepartureCode = keyof typeof DEPARTURE_MAP;
export type DepartureName = typeof DEPARTURE_MAP[DepartureCode];
...
export type ArrivalCountry = keyof typeof ARRIVAL_MAP;
export type ArrivalInfo = typeof ARRIVAL_MAP[ArrivalCountry];
export type ArrivalCode = ArrivalInfo[0];
export type ArrivalSlug = ArrivalInfo[1];
...
} as const satisfies Record<string, FilterItem>;

export type FilterKey = keyof typeof FILTERS;

export const ENDPOINTS = {
    packageEndpoints: {
        listArrivalLocations: '/PackageTourHotelProduct/ListArrivalLocations',
        listAvailableDates: '/PackageTourHotelProduct/ListAvailableDates',
        listAvailableNights: '/PackageTourHotelProduct/ListAvailableNights',
        priceSearchEncrypt: '/PackageTourHotelProduct/PriceSearchEncrypt',
    },
    onlyHotelEndpoints: {
...
export type PackageEndpointKeys = keyof Endpoints['packageEndpoints'];
export type OnlyHotelEndpointKeys = keyof Endpoints['onlyHotelEndpoints'];
